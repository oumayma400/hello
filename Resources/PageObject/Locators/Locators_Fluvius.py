class Locator_Fluvius(object):
	...
	#firmware campaign
	firmware_detail_page = "//siconia-lib-body-nav-menu/div/div/div/div/div/button[1]"

	#key renewal
	keyrenewal_detail_page = "//siconia-lib-body-nav-menu/div/div/div/div/div/button[2]"
